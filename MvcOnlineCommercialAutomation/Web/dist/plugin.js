CKEDITOR.plugins.add("fontawesome5",
    {
        ...
        init: function(editor) {
            ...
            editor.addCommand("fontawesome5",
                new CKEDITOR.dialogCommand("ckeditorFaDialog", { allowedContent: "span(!fa-*)" }));
            editor.ui.addButton("fontawesome5",
                {
                    label: "Font Awesome " +
                    ...
                    toolbar: "insert",
                    icon: this.path + "icons/fontawesome5.png"
                });
