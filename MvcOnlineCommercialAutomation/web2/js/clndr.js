            ...
            if (this.options.events) {
                ...
                if (this.options.multiDayEvents) {
                    target.events = $.makeArray($(this.options.events).filter(function() {
                        ...
                        return ((target.date.isSame(this._clndrStartDateObject, "day") ||
                                target.date.isAfter(this._clndrStartDateObject, "day")) &&
                            (target.date.isSame(this._clndrEndDateObject, "day") ||
                                target.date.isBefore(this._clndrEndDateObject, "day")));
                    }));
                } else {
                    target.events = $.makeArray($(this.options.events).filter(function() {
                        // filter the dates down to the ones that match.
